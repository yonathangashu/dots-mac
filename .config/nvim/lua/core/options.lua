vim.wo.number = true -- Line Numbers Show
vim.o.relativenumber = true -- Set relative numbers true
vim.o.clipboard = 'unnamedplus' -- Sync clipboard between OS and Nvim
vim.o.wrap = false -- Lines dont run off screen
vim.o.linebreak = true -- Works with wrap, don't split words when wrapping
vim.o.autoindent = true -- Copy indent from current line when starting new
vim.o.ignorecase = true -- Case-insensitive searches by default
